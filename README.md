...
1. Clone the repository:
    ```bash
    git clone https://github.com/marvqute/nextwork-web-project.git
    ```
...
Marvis Edorodion - [edorodionmarv1992@gmail.com](mailto:edorodionmarv1992@gmail.com)

<br>

## Project PDF link
https://drive.google.com/drive/folders/13UhTd0HEiY4bq3hDgXULERN81AB8cDlY?usp=sharing
